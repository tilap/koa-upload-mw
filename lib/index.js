        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 10:
                ...
                mediaPromises.push((0, _extractMediaInfos2.default)(tmpFilepath).then(function (file) {
                  ...
                  return Promise.all(config.map(function (cfg, index) {
                    ...
                    return (0, _assertConditions2.default)(conditions, formFileData).then(function () {
                      return logger.trace('Conditions passed', { mediaKey: mediaKey, uploader: name });
                    }).then(function () {
                      return (0, _assertValidators2.default)(validators, formFileData);
                    }).then(function () {
                      return logger.trace('Validation passed', { mediaKey: mediaKey, uploader: name });
                    }).then(function () {
                      return storage(file);
                    }).then(function () {
                      return logger.trace('Storage passed', { mediaKey: mediaKey, uploader: name });
              ...
              Promise.all(mediaPromises).then(function (mediaResults) {
                ...
                ctx.body = { result: 'error', error: error }; // eslint-disable-line no-param-reassign
              });
